...
TEST(POLYGON_CLIPPING_TEST, test_create_vertex_list_should_return_correct_vertex_list) {
    ...
    Polygon polygon2 = Polygon({Point(8, 10), Point(16, 10), Point(14, 2), Point(6, 2)});
    ...
    ASSERT_EQ(points, std::vector<Point>({Point(1, 5), Point(3, 2), Point(6, 6),
                                          Point(6.88888888888888888888, 5.55555555555555555555), Point(10, 4),
